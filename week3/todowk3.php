...
DONE Experimenteer met strings en pas single & double quotes toe

DONE Experimenteer met string met variables met zowel single en double quotes
...
Gebruik een string als array; print het middelste karakter van een string, overschrijf deze en print nogmaals

Vergelijk strings met elkaar, met de == operator en de === operator

Vergelijk (sub)strings met elkaar met de volgende functies: strcmp, strcasecmp, substr_compare 

Pas de volgende functies toe: strpos, strstr, stripos, stristr en beschrijf in comment wat er gebeurd. 

Pas de volgende functies toe: strspn, strcspan, str_replace, substr_replace,str_irpleace, met zowel 
    string als arrays. Beschrijf in comment wat er gebeurd. 
...
Doorloop alle stappen op https://regexone.com/
